...
import { getPatients, deletePatient, updatePatient, Patient } from '../api/patientApi';
...
const PatientManagement: React.FC = () => {
  ...
  const handleUpdate = async (data: Patient) => {
    ...
    try {
      ...
      setPatients(patients.map(patient => patient._id === editingPatient._id ? data : patient));
    } catch (error) {
